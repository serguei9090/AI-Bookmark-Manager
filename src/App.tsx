    ...
    fols: [
      {
        ...
        name: "Frontend React",
        promptContext:
          "React libraries, hooks, css-in-js, tailwind framework, vite builds.",
      },
      {
        id: "f_back",
        parentId: null,
        name: "Cloud & Database",
        promptContext:
          "Express endpoints, GCP hosting, persistent database schemas, SQL, firebase.",
      },
      {
        id: "f_sub_css",
        parentId: "f_react",
        name: "Micro Styling CSS",
        promptContext: "Sleek buttons, animations, keyframes, transitions.",
      },
    ],
    bms: [
      {
        id: "b1",
        title: "React Documentation - Quick Start Core",
        url: "https://react.dev/reference/react",
        folderId: "f_react",
        tags: ["docs", "react"],
        summary: "Primary React components manual.",
        dateAdded: Date.now(),
      },
      {
        id: "b2",
        title: "Tailwind CSS Class Reference Layout",
        url: "https://tailwindcss.com/docs",
        folderId: "f_react",
        tags: ["styling", "css"],
        summary: "Fluid utility layout styling references.",
        dateAdded: Date.now() - 100,
      },
      {
        id: "b3",
        title: "Express.js - Node Server Framework",
      ...
      {
        id: "b4",
        title: "Vite Bundler Fast HMR Builds",
        url: "https://vite.dev",
        folderId: "f_react",
        tags: ["build", "vite"],
        summary: "Modern frontend compilation and bundling asset loader.",
        dateAdded: Date.now() - 110,
      },
      {
        id: "b5",
        title: "Node Server Fast Execution",
        url: "https://expressjs.com",
        folderId: null,
        tags: ["backend"],
        summary: "Duplicate node link to test cleanser.",
    ...
    fols: [
      {
        ...
        name: "Daily News",
        promptContext:
          "Breaking articles, world politics, international headlines.",
      },
      {
        id: "f_arts",
        parentId: null,
        ...
        promptContext:
          "Design inspiration, high-resolution visual art, creative museums.",
      },
    ],
    bms: [
      {
        id: "c1",
        title: "The New York Times Online Daily",
        url: "https://nytimes.com",
        folderId: "f_news",
        tags: ["news", "media"],
        summary: "Latest breaking world and country columns.",
        dateAdded: Date.now(),
      },
      {
        id: "c2",
        title: "Behance Portfolio Design Deck",
        url: "https://behance.net",
        folderId: "f_arts",
        tags: ["inspiration", "arts"],
        summary: "High quality interface layout showcases.",
        dateAdded: Date.now() - 400,
      },
      {
        id: "c3",
        title: "CNN International Global Broadcast",
        url: "https://cnn.com",
        folderId: "f_news",
        tags: ["news", "channel"],
        summary: "",
...
function AppLayout() {
  const { bookmarks, settings, setSettings, injectPresetData, clearDatabase } =
    useAppContext();
  ...
  const injectPreset = (key: string) => {
    ...
    if (data) {
      injectPresetData(
        key === "software" ? "Dev Resources" : "Creative News",
        data.bms,
        data.fols,
      );
      alert(
        `Injected ${data.bms.length} bookmarks and ${data.fols.length} folder structures! Go to Categories or Bookmarks view to test semantic analysis.`,
      );
    }
  };
  ...
  const clearAllBookmarks = () => {
    if (
      confirm("Are you sure you want to clear your current selection database?")
    ) {
      clearDatabase();
    }
  };
      ...
      <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-6 py-4 flex flex-col md:flex-row md:items-center justify-between gap-4 z-10 shadow-sm">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="font-bold text-gray-950 dark:text-white text-base">
                Chrome Extension Dev Sandbox
              </span>
              <span className="text-[10px] bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 px-2 py-0.5 rounded font-bold uppercase tracking-wider">
                Active
              </span>
            </div>
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
              Test simulated Chrome extension dropdown popups & folders
              instantly.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <div className="flex bg-gray-100 dark:bg-gray-800 p-1.5 rounded-xl border border-gray-200 dark:border-gray-700 text-xs text-gray-700 dark:text-gray-300 font-medium items-center gap-2">
            <span className="px-2 text-[11px] font-bold text-gray-400 uppercase tracking-wide">
              Dataset Prefab:
            </span>
            <button
              type="button"
          ...
          <div className="flex bg-gray-100 dark:bg-gray-800 p-1 rounded-xl border border-gray-200 dark:border-gray-700">
            ...
            <button
              type="button"
              onClick={() =>
                setSettings((prev) => ({ ...prev, viewMode: "extension" }))
              }
            ...
            <div className="w-full max-w-4xl bg-[#f2f3f5] dark:bg-gray-800/90 rounded-2xl shadow-2xl overflow-hidden border border-gray-300/60 dark:border-gray-800 flex flex-col transition-all duration-300">
              ...
              <div className="bg-white dark:bg-gray-900 px-4 py-2 flex items-center gap-3 border-b border-gray-200 dark:border-gray-800">
                ...
                <div className="flex-1 bg-[#efeff1] dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg py-1.5 px-3.5 text-xs text-gray-600 dark:text-gray-400 flex items-center justify-between font-mono">
                  ...
                  <span className="text-[10px] text-gray-400 bg-gray-200 dark:bg-gray-800 px-1.5 rounded uppercase font-bold tracking-wider scale-95">
                    Security Verified
                  </span>
                </div>
              ...
              <div className="h-[600px] overflow-hidden bg-gray-50 dark:bg-gray-950 flex relative">
                ...
                <div className="flex-1 flex flex-col items-center justify-center p-8 text-center text-gray-400/80 bg-slate-50 dark:bg-slate-900/40 relative">
                  ...
                  <h3 className="font-bold text-lg text-gray-700 dark:text-gray-200">
                    Modern Browser Client Core Workspace
                  </h3>
                  <p className="text-xs text-gray-500 dark:text-gray-450 max-w-sm mt-1.5 leading-relaxed">
                    This simulated space mimics your standard internet browser
                    viewing field. Click the highlighted blue extension icon in
                    the toolbar above to deploy the extension dropdown popover.
                  </p>
